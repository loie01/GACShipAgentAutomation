...
//*******************************SANITY_STEPS*************************************************//
        ...
        public static void LaunchApplication()
        {
            ...
            Excel excel = new Excel(@"C:\Users\DTH6HD2\.jenkins\workspace\Build SLN\ConsoleApp1\TestData\GACShipTestData2.xlsx", "LogIn");
        ...
        public static void VerifySOFRequiredJobCount()
        {
           ...
           // string JobCount = landingPage.SOFRequiredJobCount.GetAttribute("innerText");
        ...
        public static void VerifyFinalDARequiredJobCount()
        {
            ...
            //string JobCount = landingPage.FinalDARequiredJobCount.GetAttribute("innerText");
        ...
        public static void ClickCargoTabSideBarMenu()
        {
            PropertyCollection.ChildTest = PropertyCollection.ExtentTest.CreateNode(GetActions.GetMyMethodName());
            GACShip_Agent_LandingPage landingpage = new GACShip_Agent_LandingPage();
            //landingpage.MenuButtonCargo.ClickButton("Cargo");
        ...
        public static void ClickBankRemitTabSideBarMenu()
        {
            PropertyCollection.ChildTest = PropertyCollection.ExtentTest.CreateNode(GetActions.GetMyMethodName());
            GACShip_Agent_LandingPage landingpage = new GACShip_Agent_LandingPage();
            //landingpage.MenuButtonBankRemit.ClickButton("Bank Remit Tab");
        ...
        public static void ClickSearchTabSideBarMenu()
        {
            PropertyCollection.ChildTest = PropertyCollection.ExtentTest.CreateNode(GetActions.GetMyMethodName());
            GACShip_Agent_LandingPage landingpage = new GACShip_Agent_LandingPage();
            //landingpage.MenuButtonSearch.ClickButton("Search");
...
//*******************************ACKNOWLEDGEMENT_REQUIRED*************************************************//
        ...
        public static void ClickFirstAcknowledgementRequiredJob()
        {
            PropertyCollection.ChildTest = PropertyCollection.ExtentTest.CreateNode(GetActions.GetMyMethodName());
            GACShip_Agent_LandingPage landingpage = new GACShip_Agent_LandingPage();
            //landingpage.FirstAcknowledgementRequiredJob.ClickButton("First Acknowledge Job");
        ...
        public static void SearchAcknowledgementRequiredJob()
        {
            ...
            //landingPage.MenuSearchIcon.Click();
        ...
        public static void SearchAndVerifyAcknowledgementRequiredJob()
        {
            PropertyCollection.ChildTest = PropertyCollection.ExtentTest.CreateNode(GetActions.GetMyMethodName());
            GACShip_Agent_LandingPage landingPage = new GACShip_Agent_LandingPage();
            //string FirstAcknowledgementRequiredJobNumber = landingPage.FirstAcknowledgementRequiredJob.GetAttribute("innerText");
            ...
            //landingPage.MenuSearchTextField.SendKeys(FirstAcknowledgementRequiredJobNumber);
            ...
            //landingPage.MenuSearchIcon.ClickButton("Search");
            SetActions.ClickButton(landingPage.MenuSearchIcon, "Search");
            ...
            //string header = acknowledgementPage.AcknowledgementPageJobNumber.GetAttribute("innerText");
        ...
        public static void GetText()
        {
            ...
            if (InitialAssertion.checkCountMatch(JobCount, RowCount))
                {
                    SeleniumReporting.WriteResults(true, "SOF Required Job Count Matches Row Count   " + " ------ ");
...
//***************************************************PDA_JOBS*******************************************************************//
        ...
        public static void ClickFirstProformaRequiredJob()
        {
            PropertyCollection.ChildTest = PropertyCollection.ExtentTest.CreateNode(GetActions.GetMyMethodName());
            GACShip_Agent_LandingPage landingpage = new GACShip_Agent_LandingPage();
            //landingpage.FirstProformaRequiredJob.ClickButton("Firt Proforma Required Job");
        ...
        public static void SearchPDAJob()
        {
            ...
            //newpage.MenuSearchTextField.SendKeys(excel.ReadDatabyColumnName("GACShip", "PDAJob"));
            SetActions.FillInTextField(excel.ReadDatabyColumnName("GACShip", "PDAJob"), newpage.MenuSearchTextField);
            //newpage.MenuSearchIcon.Click();
        ...
        public static void SearchAndVerifyPDARequiredJob()
        {
            PropertyCollection.ChildTest = PropertyCollection.ExtentTest.CreateNode(GetActions.GetMyMethodName());
            GACShip_Agent_LandingPage landingPage = new GACShip_Agent_LandingPage();
            //string FirstPDARequiredJobNumber = landingPage.FirstProformaRequiredJob.GetAttribute("innerText");
            ...
            //landingPage.MenuSearchTextField.SendKeys(FirstPDARequiredJobNumber);
            ...
            GACShipPDAPage PDAPage = new GACShipPDAPage();
            string header = PDAPage.PDAPageJobNumber.GetAttribute("innerText");
        ...
        public static void VerifyPDALandingPageObject()
        {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.PDAPageHeader))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.PDALockButton))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.PDAPageSubmitButton))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.PDAPageExportToExcelButton))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.PDAPageSaveButton))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.PDAPageExpectedDates))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.PDAPageVersionDescription))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.PDAPageVersionProvider))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.PDAPageVersionPaidBy))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.PDAPageVersionCurrency))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.PDAPageVersionQuantity))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.PDAPageVersionUSDUnitPrice))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.PDAPageVersionUSDAmount))
            {
        ...
        public static void ClickEditPDAJobButton()
        {
            ...
            newpage.PDAJobEditButton.Click();
        ...
        {
            GACShipPDAPage newpage = new GACShipPDAPage();
            newpage.PDAPageCheckAllButton.Click();
            System.Threading.Thread.Sleep(8000);
        }
        ...
        public static void ClickFirstCheckBoxPDAJobButton()
        {
            ...
            //newpage.FDAPageFirstCheckBoxFDAJobs.ClickButton("First FDA Checkbox");
        ...
        {
            GACShipPDAPage newpage = new GACShipPDAPage();
            newpage.PDAPageAddNewRowButton.Click();
            System.Threading.Thread.Sleep(3000);
            newpage.PDAPageAddedNewRowDescription.Click();
            System.Threading.Thread.Sleep(2000);
            newpage.PDAPageAddedNewRowDescriptionTextField.SendKeys(" ");
            System.Threading.Thread.Sleep(2000);
            newpage.PDAPageSelectAnchorageDuesFromDropdown.Click();
            System.Threading.Thread.Sleep(8000);
        }
        ...
        {
            GACShipPDAPage newpage = new GACShipPDAPage();
            newpage.PDAPageSubmitButton.Click();
            System.Threading.Thread.Sleep(5000);

            if (InitialAssertion.IfElementIsVisible(newpage.PDAPageDisclaimerModalCheckbox))
            {
                newpage.PDAPageDisclaimerModalCheckbox.Click();
                newpage.PDAPageDisclaimerModalSubmitButton.Click();
                System.Threading.Thread.Sleep(5000);
            }
            else
                return;
        ...
        {
            GACShipPDAPage landingpage = new GACShipPDAPage();
            GetActions.VerifyIfElementIsPresent(PropertyCollection.Driver, PropertyName.Name, landingpage.PDASuccessfullySubmittedMessage);
            System.Threading.Thread.Sleep(2000);
        }
...
//***************************************************SOF_JOBS*******************************************************************//
        ...
        public static void ClickFirstSOFRequiredJob()
        {
            PropertyCollection.ChildTest = PropertyCollection.ExtentTest.CreateNode(GetActions.GetMyMethodName());
            GACShip_Agent_LandingPage landingpage = new GACShip_Agent_LandingPage();
            //landingpage.FirstSOFRequiredJob.ClickButton("First SOF Required Job");
        ...
        public static void SearchSOFJob()
        {
            Excel excel = new Excel(@"C:\Users\edqu01\Documents\GAC Automation\GACShip Agent GIT Repository\ConsoleApp1\TestData\GACShipTestData.xlsx", "TestData");
            GACShip_Agent_LandingPage newpage = new GACShip_Agent_LandingPage();
            //newpage.MenuSearchTextField.SendKeys(excel.ReadDatabyColumnName("GACShip", "SOFJob"));
        ...
        public static void SearchAndVerifySOFRequiredJob()
        {
            PropertyCollection.ChildTest = PropertyCollection.ExtentTest.CreateNode(GetActions.GetMyMethodName());
            GACShip_Agent_LandingPage landingPage = new GACShip_Agent_LandingPage();
            //string FirstSOFRequiredJobNumber = landingPage.FirstSOFRequiredJob.GetAttribute("innerText");
            ...
            //landingPage.MenuSearchTextField.SendKeys(FirstSOFRequiredJobNumber);
            ...
            if (InitialAssertion.IfElementIsVisible(SOFPage.SOFPageJobNumber))
            {
            ...
            string header = SOFPage.SOFPageJobNumber.GetAttribute("innerText");
        ...
        public static void VerifySOFLandingPageObject()
        {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.SOFPageHeader))
            {
            ...
            if (InitialAssertion.ifElementIsPresent(PropertyCollection.Driver, By.XPath(landingpage.Nuve)))
            {
                SeleniumReporting.ElementPresentVerification(true, "SOF Page Header");
            }
            else
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.SOFTimingPlaceHolder))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.LockButton))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.DownloadSOFReportButton))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.DocumentUploadViewButton))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.SaveButton))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.SubmitButton))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.ETAOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.ETDOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.ATAOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.ATDOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.NoticeOfReadinessOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.CommencedStartedOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.AnchoredStartedOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.CompletedStartedOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.AllFastStartedOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.HSSEIncidentHeaderOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.HSSEYesRadioButtonOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.HSSENoRadioButtonOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.CustomerComplaintHeaderOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.CustomerCompliantYesRadioButtonOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.CustomerCompliantNoRadioButtonOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.OtherFeedbackHeaderOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.OtherFeedbackYesRadioButtonOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.OtherFeedbackNoRadioButtonOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.ArrivalRemarksTextAreaOfSOFJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.SOFEventsAndDetailsTabButton))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.SOFEventsAndDetailsDescription))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.SOFEventsAndDetailsEventDate))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.SOFEventsAndDetailsUnit))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.SOFEventsAndDetailsQuantity))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.SOFEventsAndDetailsCargo))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.SOFEventsAndDetailsRemarks))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.PageCheckAllButton))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.AddNewRowButton))
            {
            ...
            landingpage.ArrivalDetailsTabButton.Click();
            System.Threading.Thread.Sleep(1500);

            //ArrivalDetailsDescription Existence Verification
            if (InitialAssertion.IfElementIsVisible(landingpage.ArrivalDetailsDescription))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.ArrivalDetailsUnit))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.ArrivalDetailsQuantity))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.ArrivalDetailsPurpose))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.ArrivalDetailsRemarks))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.DepartureDetailsDescription))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.DepartureDetailsUnit))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.DepartureDetailsQuantity))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.DepartureDetailsPurpose))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.DepartureDetailsRemarks))
            {
        ...
        {
            GACShip_Agent_LandingPage newpage = new GACShip_Agent_LandingPage();
            // newpage.MenuButtonSOFJobsButton.Click();
        ...
        {
            GACShip_Agent_LandingPage newpage = new GACShip_Agent_LandingPage();
            //newpage.MenuButtonFDAJobsButton.Click();
        ...
        {
            GACShip_Agent_FDAPage newpage = new GACShip_Agent_FDAPage();
            newpage.FDAJobNotEditableButton.Click();
        }

        public static void AddNewRowToSOFJob()
        {
            GACShip_Agent_SOFPage newpage = new GACShip_Agent_SOFPage();
            newpage.AddNewRowButton.Click();
        }

        public static void ClickArrivalDetailsTabSOFPage()
        {
            GACShip_Agent_SOFPage newpage = new GACShip_Agent_SOFPage();
            newpage.ArrivalDetailsTabButton.Click();
            System.Threading.Thread.Sleep(2000);
        }
        ...
        {
            GACShip_Agent_SOFPage newpage = new GACShip_Agent_SOFPage();
            newpage.AddNewRowArrivalDetailsTab.Click();
            System.Threading.Thread.Sleep(2000);
        }
        ...
        public static void PopulateArrivalDetailsTab()
        {
            GACShip_Agent_SOFPage newpage = new GACShip_Agent_SOFPage();
            System.Threading.Thread.Sleep(5000);
            newpage.ArrivalDetailsDescriptionTextField.Click();
            newpage.ArrivalDetailsDescriptionDropdown.Click();
            System.Threading.Thread.Sleep(5000);
            newpage.ArrivalDetailsDescriptionDropdownSelectIPOOnArrival.Click();
            System.Threading.Thread.Sleep(5000);
            newpage.UnitDropdownArrivalDetails.Click();
            System.Threading.Thread.Sleep(5000);
            newpage.SelectKiloTonnesInArrivalDetailsUnitDropdown.Click();
            newpage.ArrivalDetailsQuantityTextField.SendKeys("1");
            newpage.PurposeDropdownArrivalDetails.Click();
            System.Threading.Thread.Sleep(5000);
            newpage.ArrivalDetailsPurposeDropdownSelectROBInSOF.Click();
            newpage.ArrivalDetailsRemarksTextField.SendKeys("This is an Automated Test!");
            System.Threading.Thread.Sleep(3000);
        }
        ...
        public static void ClickFirstCheckBoxSOFJobButton()
        {
            PropertyCollection.ChildTest = PropertyCollection.ExtentTest.CreateNode(GetActions.GetMyMethodName());
            GACShip_Agent_SOFPage newpage = new GACShip_Agent_SOFPage();
            newpage.SOFPageFirstCheckBoxSOFJobs.Click();
            System.Threading.Thread.Sleep(5000);
        }
        ...
        {
            GACShip_Agent_SOFPage newpage = new GACShip_Agent_SOFPage();
            newpage.DescriptionDropdownSOFEventsAndDetails.Click();
            System.Threading.Thread.Sleep(2000);
            newpage.SelectCommencedUllagingInSOFEventDropdown.Click();
            System.Threading.Thread.Sleep(2000);
            string dateToday = DateTime.Now.ToString("dd/MM/yyyy HH:mm");
            newpage.SOFEventDate.SendKeys(dateToday);
            newpage.UnitDropdownSOFEventsAndDetails.Click();
            System.Threading.Thread.Sleep(1000);
            newpage.SelectDateInSOFUnitDropdown.Click();
            newpage.SOFEventQuantity.SendKeys("1");
            newpage.CargoDropdownSOFEventsAndDetails.Click();
            System.Threading.Thread.Sleep(1000);
            newpage.SelectGeneralInSOFCargoDropdown.Click();
            newpage.SOFEventRemarks.SendKeys("This is an Automated Test!");
            System.Threading.Thread.Sleep(3000);
        }
        ...
        public static void EnterDatesforSOFJobs()
        {
            ...
            //Console.WriteLine(dateTomorrow);

            newpage.ETAOfSOFJob.SendKeys(dateToday);
            newpage.ETDOfSOFJob.SendKeys(dateTomorrow);
            newpage.ATAOfSOFJob.SendKeys(dateToday);
            newpage.ATDOfSOFJob.SendKeys(dateTomorrow);
            newpage.NoticeOfReadinessOfSOFJob.SendKeys(dateTomorrow);
            newpage.CommencedStartedOfSOFJob.SendKeys(dateToday);
            newpage.AnchoredStartedOfSOFJob.SendKeys(dateTomorrow);
            newpage.CompletedStartedOfSOFJob.SendKeys(dateToday);
            newpage.AllFastStartedOfSOFJob.SendKeys(dateToday);
        }

        public static void clickYESHSSEIncident()
        {
            GACShip_Agent_SOFPage newpage = new GACShip_Agent_SOFPage();
            newpage.HSSEYesRadioButtonOfSOFJob.Click();
        }

        public static void clickNOHSSEIncident()
        {
            GACShip_Agent_SOFPage newpage = new GACShip_Agent_SOFPage();
            newpage.HSSENoRadioButtonOfSOFJob.Click();
        }

        public static void clickYESCustomerComplaint()
        {
            GACShip_Agent_SOFPage newpage = new GACShip_Agent_SOFPage();
            newpage.CustomerCompliantYesRadioButtonOfSOFJob.Click();
        }

        public static void clickNOCustomerComplaint()
        {
            GACShip_Agent_SOFPage newpage = new GACShip_Agent_SOFPage();
            newpage.CustomerCompliantNoRadioButtonOfSOFJob.Click();
        }

        public static void clickYESOtherFeedback()
        {
            GACShip_Agent_SOFPage newpage = new GACShip_Agent_SOFPage();
            newpage.OtherFeedbackYesRadioButtonOfSOFJob.Click();
        }

        public static void clickNoOtherFeedback()
        {
            GACShip_Agent_SOFPage newpage = new GACShip_Agent_SOFPage();
            newpage.OtherFeedbackNoRadioButtonOfSOFJob.Click();
        }

        public static void EnterArrivalRemarks()
        {
            GACShip_Agent_SOFPage newpage = new GACShip_Agent_SOFPage();
            newpage.ArrivalRemarksTextAreaOfSOFJob.SendKeys("This is an Automated Test!");
        }

        public static void verifySOFSuccesfullySubmittedMEssage()
        {
            GACShip_Agent_SOFPage landingpage = new GACShip_Agent_SOFPage();
            GetActions.VerifyIfElementIsPresent(PropertyCollection.Driver, PropertyName.Name, landingpage.SOFSuccessfullySubmittedMessage);
            System.Threading.Thread.Sleep(2000);
        }
...
//***************************************************FDA_JOBS*******************************************************************//
        ...
        public static void SearchFDAJob()
        {
            ...
            GACShip_Agent_LandingPage newpage = new GACShip_Agent_LandingPage();
            //newpage.MenuSearchTextField.SendKeys(excel.ReadDatabyColumnName("GACShip", "FDAJob"));
        ...
        public static void VerifyFDALandingPageObject()
        {
            ...
            //landingpage.ViewTypeDropdown.Click();
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.FDAPageCheckAllButton))
            {
            ...
            landingpage.FDADatesDropdown.Click();
            //ETAOfFDAJob Existence Verification
            if (InitialAssertion.IfElementIsVisible(landingpage.ETAOfFDAJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.ETDOfFDAJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.ATAOfFDAJob))
            {
            ...
            if (InitialAssertion.IfElementIsVisible(landingpage.ATDOfFDAJob))
            {
        ...
        public static void SearchAndVerifyFDARequiredJob()
        {
            PropertyCollection.ChildTest = PropertyCollection.ExtentTest.CreateNode(GetActions.GetMyMethodName());
            GACShip_Agent_LandingPage landingPage = new GACShip_Agent_LandingPage();
            //string FirstFDARequiredJobNumber = landingPage.FirstFinalDARequiredJob.GetAttribute("innerText");
            ...
            //landingPage.MenuSearchTextField.SendKeys(FirstFDARequiredJobNumber);
            ...
            //string header = FDAPage.FDAPageJobNumber.GetAttribute("innerText");
        ...
        {
            GACShip_Agent_FDAPage newpage = new GACShip_Agent_FDAPage();
            newpage.FDAJobEditButton.Click();
            //System.Threading.Thread.Sleep(8000);
            //newpage.FDADateMissingModalConfirmButton.Click();
            System.Threading.Thread.Sleep(5000);
        }
        ...
        {
            GACShip_Agent_FDAPage newpage = new GACShip_Agent_FDAPage();
            newpage.FDAPageCheckAllButton.Click();
            System.Threading.Thread.Sleep(8000);
        }
        ...
        {
            GACShip_Agent_FDAPage newpage = new GACShip_Agent_FDAPage();
            newpage.FDADatesDropdown.Click();
            string dateToday = DateTime.Now.ToString("dd/MM/yyyy HH:mm");
            ...
            //Console.WriteLine(dateToday);
            //Console.WriteLine(dateTomorrow);
            //Console.WriteLine(dateYesterday);
            //Console.WriteLine(dateOneWeekFromNow);

            newpage.ETBOfFDAJob.SendKeys(dateToday);
            System.Threading.Thread.Sleep(1000);
            newpage.ATAOfFDAJob.SendKeys(dateYesterday);
            System.Threading.Thread.Sleep(1000);
            newpage.ATDOfFDAJob.SendKeys(dateTomorrow);
            System.Threading.Thread.Sleep(1000);
            newpage.ATBOfFDAJob.SendKeys(dateToday);
            System.Threading.Thread.Sleep(1000);
            newpage.ETAOfFDAJob.SendKeys(dateYesterday);
            System.Threading.Thread.Sleep(1000);
            newpage.ETDOfFDAJob.SendKeys(dateTomorrow);
            System.Threading.Thread.Sleep(1000);
        }
        ...
        {
            GACShip_Agent_FDAPage newpage = new GACShip_Agent_FDAPage();
            newpage.FDAPageToggleOnFirstRemarks.Click();
            newpage.FDAPageFirstRebillableRemarks.SendKeys("This is an automated test!");
            newpage.FDAPageFirstAgentRemarks.SendKeys("This is an automated test!");
            System.Threading.Thread.Sleep(5000);
        }
        ...
        public static void ClickSubmitFDAJobButton()
        {
            ...
            System.Threading.Thread.Sleep(8000);
            newpage.FDAPageDisclaimerModalCheckbox.Click();
            newpage.FDAPageDisclaimerModalSubmitButton.Click();
            System.Threading.Thread.Sleep(5000);

            /*
                        if (InitialAssertion.ifElementIsPresent(newpage.FDAPageDisclaimerModalCheckbox))
                        {
                            newpage.FDAPageDisclaimerModalCheckbox.Click();
                            newpage.FDAPageDisclaimerModalSubmitButton.Click();
                            System.Threading.Thread.Sleep(5000);
        ...
        {
            GACShip_Agent_LandingPage landingpage = new GACShip_Agent_LandingPage();
            //landingpage.MenuButtonSOFJobsButton.Click();
        ...
        {
            GACShip_Agent_FDAPage landingpage = new GACShip_Agent_FDAPage();
            GetActions.VerifyIfElementIsPresent(PropertyCollection.Driver, PropertyName.Name, landingpage.FDASuccessfullySubmittedMessage);
            System.Threading.Thread.Sleep(2000);
        }
...
//***************************************************Search_Page*******************************************************************//
        ...
        public static void VerifySearchPageObjects()
        {
            ...
            //PropertyCollection.Driver.FindElement(By.XPath(searchPage.JobStatusDropdown)).ClickButton("Job Status Dropdown");
            ...
            //PropertyCollection.Driver.FindElement(By.XPath(searchPage.FundedByGDCDropdown)).ClickButton("Funded by GDC");
            ...
            //PropertyCollection.Driver.FindElement(By.XPath(searchPage.ArrivalFromDateDropdown)).ClickButton("Arrival From Date");
            ...
            //PropertyCollection.Driver.FindElement(By.XPath(searchPage.ArrivalFromTimeDropdown)).ClickButton("Arrival From Time");
            ...
            //PropertyCollection.Driver.FindElement(By.XPath(searchPage.ArrivalToDateDropdown)).ClickButton("Arrival To Date");
            ...
            //PropertyCollection.Driver.FindElement(By.XPath(searchPage.ArrivalToTimeDropdown)).ClickButton("Arrival To Time");
            ...
            //PropertyCollection.Driver.FindElement(By.XPath(searchPage.ColumnDropdown)).ClickButton("Column Filter Dropdown");
...
//*******************************END_TO_END_TESTING*************************************************//
            ...
            public static void SearchForEndToEndJob()
        {
            Excel excel = new Excel(@"C:\Users\edqu01\Documents\GAC Automation\GACShip Agent GIT Repository\ConsoleApp1\TestData\GACShipTestData.xlsx", "TestData");
            GACShip_Agent_LandingPage newpage = new GACShip_Agent_LandingPage();
            //newpage.MenuSearchTextField.SendKeys(excel.ReadDatabyColumnName("GACShip", "EndToEndJob"));
